...
export interface FiscalContext { companyId: string; environment: FiscalEnvironment; issuerCityCode: string; serviceLocationCityCode: string; taxRegime?: string; effectiveAt?: string }
