...
export class MunicipalParametersController {
  ...
  @Get(':cityCode/convention') getConvention(@Param('cityCode') cityCode: string, @Query('environment') environment: FiscalEnvironment = 'test') { return this.client.getConvention(environment, cityCode); }
}
