...
export class NfseNationalProvider implements FiscalProvider {
  ...
  private async transmitSigned(invoiceId: string, dpsId: string, signedXml: string, environment: CanonicalInvoiceInput['environment'], certificate: CertificateMaterial): Promise<IssueResult> {
