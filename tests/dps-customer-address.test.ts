...
test('DPS emits structured national tomador address required by SEFIN E0234', () => {
  ...
  const result = builder.buildPreview({
    ...
    service: { description: 'Servicos de consultoria empresarial', amount: 100, nationalServiceCode: '170101', serviceLocationCityCode: '3548500', issTaxation: '1', issWithholding: '1', issRate: 3, operationIndicator: '100301', taxSituation: '000', taxClassification: '000001' },
